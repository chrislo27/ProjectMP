...
public class Item extends TexturedObject {
	...
	public void onUseStart(World world, EntityPlayer user){
	 ...
	 * @param user
	 */
	public void onUsing(World world, EntityPlayer user){
		
	}
	
	public void onUseEnd(World world, EntityPlayer user){
